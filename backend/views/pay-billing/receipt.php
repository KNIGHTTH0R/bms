           ...
           <div class="row">
            <div class="col-xs-12">
              ...
              <table class="table table-bordered" width="100%">
                  <tr>                    
                    <td rowspan="3" style="width:20%; padding:20px 10px;"><img src="../dist/img/wplogo.png"></td>
                  ...
                  <tr>                    
                    <td colspan="2" rowspan="2" style="width:20% padding:10px 80px 0px 80px; line-height: 35px; text-transform: uppercase; font-size:35px; text-align: center"><p style="margin-top: 10px">Kwitansi</p></td>                  
                    ...
                    foreach ($model as $model) {
                      ...
                      <tr>
                        ...
                        <td>'; 
                          ...
                          }else if($model->type=='SERVICECHARGE'){
