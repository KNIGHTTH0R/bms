            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <?php
                                $typeCharge=ArrayHelper::map(\backend\models\TypeCharge::find()->asArray()->all(), 'name_type', 'name_type');
                                echo $form->field($model, 'type')->dropDownList($typeCharge, 
                                         ['prompt'=>'-Choose a Type Charge-','id'=>'tariffType'])->label('Type'); 
                            ?>
                        </div>
                        <div class="col-md-3">
...
<?php 
    $this->registerJs('
        $(window).load(function(){
            ...
            else if(document.getElementById("tariffType").value=="IURAN PEMELIHARAAN LINGKUNGAN"){
                $(".elec-details, .water-details, .sf-details, .internet-details, .tv-details").hide();    
            }
