...
<header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav"><!-- Start Top Menu -->
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?=Html::img(isset(Yii::$app->user->identity->avatar) ? Yii::$app->user->identity->avatar : Yii::$app->params['uploadUrl'] . 'profiles/' . 'default_user.png', ['class' => 'user-image',]) ?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      ...
                      <?=Html::a('Profile', ['profile/view'], ['class'=>'btn btn-default btn-flat', 'data-method'=>'post']) ?>
                    </div>
