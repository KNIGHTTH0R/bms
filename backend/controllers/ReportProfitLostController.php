...
use backend\models\ReportProfitLostSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReportProfitLostController implements the CRUD actions for JurnalChild model.
 */
class ReportProfitLostController extends Controller
{
    ...
    {
        $searchModel = new ReportProfitLostSearch();
