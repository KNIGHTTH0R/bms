...
use backend\models\JurnalChildSearch;
...
/**
 * JurnalChildController implements the CRUD actions for JurnalChild model.
 */
class JurnalChildController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new JurnalChildSearch();
