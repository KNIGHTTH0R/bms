...
/**
 * BankController implements the CRUD actions for Coa model.
 */
class BankController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Coa::find()->where(['bank'=>20])->andWhere(['not', ['parent_id' => null]]),
        ]);
    ...
    public function actionCreate()
    {
        ...
        $parentId = $model->find()->where(['bank'=>20])->andWhere(['parent_id'=>null])->all();
