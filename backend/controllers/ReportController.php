...
use backend\models\ReportJurnalSearch;
...
/**
 * ReportController implements the CRUD actions for Jurnal model.
 */
class ReportController extends Controller
{
    ...
    {
        $searchModel = new ReportJurnalSearch();
    ...
    public function actionProfitLost()
    {
        return $this->render('profit-lost');
    }
