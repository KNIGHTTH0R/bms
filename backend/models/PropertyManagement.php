...
/**
 * This is the model class for table "property_management".
 *
 ...
 */
class PropertyManagement extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(Property::className(), ['property_management_id' => 'id']);
    }

    public function getUserName(){
        return $this->hasOne(UserName::className(), ['created_by' => 'user_id']);   
    }
