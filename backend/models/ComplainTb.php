...
class ComplainTb extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['date_complain'], 'safe'],
            [['complain', 'solution', 'code_unit','status_complain','date_complain_char'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'code_unit' => 'Code Unit',
            'date_complain' => 'Date Complain Int',
            'complain' => 'Complain',
            'solution' => 'Solution',
            'user_id' => 'User',
            'status_complain' => 'Status',
            'date_complain_char' => 'Date Complain',
    ...
    public function getFullName(){
        $id= $this->user->id;
        return ProfileUser::find()->where(['user_id'=>$id])->one();
    }
}
